 ...
 * @param credentials 
 */
export const login = (credentials: Model.LoginCredentials): Common.ActionResult<Model.LoginCredentials> => {
    return {
 ...
 * @param response 
 */
export const loginSuccess = (response: Model.LoginResponse): Common.ActionResult<Model.LoginResponse> => {
    return {
