...
class UserDetailForm extends React.Component<UserDetailProps, UserDetailState> {
    ...
    renderDoctorForm() {
        let passwordError =
            !this.state.pwdHasLowerCaseCharacter
            || !this.state.pwdHasMinimumLength
            || !this.state.pwdHasUpperCaseCharacter
            || !this.state.pwdHasSpecialCharacter;
