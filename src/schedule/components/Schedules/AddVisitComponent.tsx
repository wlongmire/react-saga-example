...
class AddVisitComponent extends React.Component<VisitDrawerProps, VisitDrawerState> {
    constructor() {
        super();
    ...
    handleSubmitVisit(event: any) {
        ...
        if (this.props.createVisit) {
            this.props.createVisit(newPayload);
        }
    ...
    render() {
        return (
            <form id="visit-drawer" onSubmit={this.handleSubmitVisit}>
                ...
                />
                <div>
                    <ChipCollection items={this.state.payload.diagnosis || []} />
                    <DropDownTemplate
                        title="Add Diagnosis"
                        dataArray={
